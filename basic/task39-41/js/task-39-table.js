    ...
    switch (flag) {
        case "00":
            for (let i in dataList) {
                tBody += "<tr data-index='" + i + "'><td data-index='" + i + "'>" + dataList[i]["product"] + "</td><td data-index='" + i + "'>" + dataList[i]["region"] + "</td>";
        ...
        case "01":
            for (let i in dataList) {
                ...
                if (i == 0) {
                    tBody += "<td data-index='" + i + "' rowspan='" + dataList.length +"'>" + dataList[i]["product"] + "</td><td data-index='" + i + "'>" + dataList[i]["region"] + "</td>";
                }
                else {
        ...
        case "10":
            for (let i in dataList) {
                tBody += "<tr data-index='" + i + "'>";
                if (i == 0) {
                    tBody += "<td data-index='" + i + "' rowspan='" + dataList.length +"'>" + dataList[i]["region"] + "</td><td data-index='" + i + "'>" + dataList[i]["product"] + "</td>";
                }
                else {
